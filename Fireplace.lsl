...
default {
    ...
    touch_start(integer totalNumber) {   
        ...
        promptText("Fill in the blank! '__________ is an important part of Privacy since it is how individuals express how others can use what information.", "permission");
    }
    
    listen(integer chan, string name, key id, string msg) {
        msg = llToLower(msg);
        if (msg == currentAnswer) {        
            dialog("Nice job! The first letter is 'V'", close);
        } else {
